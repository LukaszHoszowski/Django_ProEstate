...
from User.views import SignUpView, ProfileView, UserLoginView, UserLogoutView, UpdatePassword, \
    ProfileCreateBuildingView, ProfileCreateFlatView, ProfileCreateAdditionalView

app_name = 'User'
urlpatterns = [
    path('signup/', SignUpView.as_view(), name='signup'),
    path('profile_creation_additional/', ProfileCreateAdditionalView.as_view(), name='profile_create_building'),
